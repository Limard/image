...
go test github.com/Limard/image/font/sfnt -args -proprietary
...
go test github.com/Limard/image/font/sfnt -test.run=ProprietaryMicrosoft -args -proprietary etc
*/
